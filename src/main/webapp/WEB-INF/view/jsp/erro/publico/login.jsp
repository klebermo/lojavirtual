...
<html lang="en">
  <head>
    ...
    <link href="<c:out value="${pageContext.request.contextPath}/extra/css/navbar.css"/>" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h1>N&atilde;o foi possivel efetuar o login</h1>
        <p>
          <a class="btn btn-lg btn-primary" href="<c:out value="${pageContext.request.contextPath}/acesso/login"/>" role="button">Tentar novamente</a>
        </p>
      </div>
