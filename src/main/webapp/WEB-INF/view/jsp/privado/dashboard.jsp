...
<html lang="en">
  <head>
    ...
    <link href="<c:out value="${pageContext.request.contextPath}/extras/css/dashboard.css"/>" rel="stylesheet">
  ...
  <body>
    ...
    <script src="<c:out value="${pageContext.request.contextPath}/extra/js/docs.min.js"/>"></script>
  </body>
</html>
